...
/**
 * TbTipopago generated by hbm2java
 */
public class TbTipopago  implements java.io.Serializable {
    ...
    public TbTipopago(String nombre, String descripcion) {
        this.nombre = nombre;
        this.descripcion = descripcion;
    }
    public TbTipopago(String nombre, String descripcion, Set tbFacturas, Set tbPedidoses) {
       this.nombre = nombre;
       this.descripcion = descripcion;
